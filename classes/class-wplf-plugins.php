  ...
  private function __construct() {
    add_action(
      ...
      add_submenu_page(
        ...
        __( 'WP Libre Form plugins', 'wp-proposal' ),
        __( 'Plugins', 'wp-proposal' ),
        'manage_options',
        'wplf-plugins',
      ...
      <form method="post" action="<?php echo esc_attr( $link ); ?>">
        ...
        <p>
          <button class="button button-primary">
            <?php echo esc_html__( 'View feature and close this notice', 'wp-proposal' ); ?>
          </button>
        </p>
      </form>
    </div>
      ...
      <div class="wplf-plugin-box__meta">
        ...
        <div class="wplf-plugin-box__meta--links">
          <?php if ( $link ) {
            ...
            >
              <?php echo esc_html__( 'Plugin page', 'wp-proposal' ); ?>
            </a>
          <?php } ?>
          ...
          <?php if ( $settings_page_presumed_link ) {
            ...
            <a
              ...
              rel="noreferrer noopener"
            >
              <?php echo esc_html__( 'Plugin settings', 'wp-proposal' ); ?>
            </a>
          <?php } ?>
        </div>
    ...
    <div class="wplf-plugins">
      <header class="wplf-plugins-menu nav-tab-wrapper">
        <a href="#" class="nav-tab" data-page="General">
          <?php echo esc_html__( 'General', 'wp-proposal' ); ?>
        </a>
      ...
      <div class="wplf-plugins-page" data-page="General">
        <h1><?php echo esc_html__( 'WP Libre Form plugins', 'wp-proposal' ); ?></h1>
        <p>
          <?php echo esc_html__(
        ...
        <?php if ( ! empty( $enabled ) ) { ?>
          <h2><?php echo esc_html__( 'Enabled plugins', 'wp-proposal' ); ?></h1>
        ...
        <?php if ( ! empty( $recommended ) ) { ?>
          <h2><?php echo esc_html__( 'Recommended plugins', 'wp-proposal' ); ?></h1>
  ...
  private function get_recommended_plugins() {
    $list = [
      ...
      'Formbuilder' => $this->fill_plugin_data(
           [
        'name' => 'Formbuilder',
        'link' => 'https://github.com/k1sul1/wp-proposalbuilder',
